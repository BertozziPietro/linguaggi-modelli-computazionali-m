...
trait ConsoleLogger extends BehaviourStacker[String] {
  abstract override def addBehaviour(input: String): Unit = {
...
trait BaseAddBehaviour extends BehaviourStacker[String] {
  override def addBehaviour(input: String): Unit = {}
}

class MyLogger extends BaseAddBehaviour with ConsoleLogger with FileLogger {
